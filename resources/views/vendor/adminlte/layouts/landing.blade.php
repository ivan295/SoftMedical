...
<div id="app" v-cloak>
    ...
    <section id="desc" name="desc">
            ...
            <div class="container">
                <div class="row centered">
                    ...
                    <div class="col-lg-4">
                        ...
                        <h3><!--/ texto para icono  --></h3>
                    </div>
                    <div class="col-lg-4">
                        <img src="{{ asset('/img/intro02.png') }}" alt="">
                        <h3><!--/ texto para icono 2--></h3>
                        <p> <!--/ texto para icono2 --> </p>
                    </div>
                    <div class="col-lg-4">
                        <img src="{{ asset('/img/intro03.png') }}" alt="">
                        <h3><!--/ texto para icono 3 --></h3>
                        <p><!--/ texto para icono 3 --></p>
                    </div>
                </div>
                <br>
                <hr>
        ...
        <div id="features">
            <div class="container">
                <div class="row">
                    <h1 class="centered"><!--/ titulo e seccion3 --></h1>
                    <br>
                    <br>
